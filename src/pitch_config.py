...
try:
    from sports.configs.soccer import SoccerPitchConfiguration as _SportsSoccerPitchConfiguration
    SoccerPitchConfiguration = _SportsSoccerPitchConfiguration
except ImportError:
    @dataclass
    class SoccerPitchConfiguration:
        """
        Standard Soccer Pitch Configuration in centimeters.
        Matches the 32-keypoint specification of football-field-detection model.
        """
        width: int = 7000  # [cm]
        length: int = 12000  # [cm]
